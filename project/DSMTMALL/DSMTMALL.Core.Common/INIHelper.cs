...
namespace DSMTMALL.Core.Common
{
    public class INIHelper
    {
        ...
        public static string GetValue(string section, string key, string defaultValue, string iniFile="")
        {
            try
            {
                iniFile = string.IsNullOrEmpty(iniFile) ? HttpContext.Current != null ? HttpContext.Current.Server.MapPath("/MyConfig.ini") : AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "MyConfig.ini" : iniFile;
