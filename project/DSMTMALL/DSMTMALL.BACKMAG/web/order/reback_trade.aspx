<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reback_trade.aspx.cs" Inherits="DSMTMALL.BACKMAG.web.order.reback_trade" %>
        ...
        <div class="main-content">
            ...
            <div class="page-heading">
                <ol class="breadcrumb">
                    <li>后台管理</li>
                    <li>退款流水</li>
                    <li class="active">（默认当月）总退款流水：<span id="moneyAccount" runat="server"></span></li>
                </ol>
            </div>
            <div class="wrapper">
                <div class="form-inline pull-right">
                    ...
                    <div class="input-group input-group-sm">
                        <input type="text" runat="server" id="iptSearch" class="form-control input-sm" mydata="searchName" placeholder="请输入流水编号" />
                ...
                <div id="divTable">
                    ...
                    <table id="tableOrderList" class="table table-striped table-condensed table-hover table-bordered">
                        <asp:Repeater ID="repeaterOrderList" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td name="tNo" class="my-overflow-title"><%# Eval("ReBackTradeNo") %></td>
                                    <td name="tNo_1" class="my-overflow-title"><%# Eval("TradeNo") %></td>
                                    <td name="tPrice"><%# Eval("ReBackMoney") %></td>
                                    <td name="tStatus"><%# Eval("NComfirmStatus") %></td>
                                    <td name="tName"><%# Eval("CpyName") %></td>
                                    <td name="tTime"><%# Eval("ReBackTime") %></td>
                                    <td name="tTime"><%# Eval("ComfirmTime") %></td>
                                    <td name="tOperation">
