...
{
    public partial class unusual_trade : System.Web.UI.Page
    {
        ...
        public object GetGoodsList(string comfirmStatus,string byPayID)
        {
            ...
            int listCount = new DB.BLL.MB_Bll(DBEnum.Slave).GetByPageUnusualTradeListCount(byTimeStart,byTimeEnd,comfirmStatus,byPayID,searchName);
            string url = "/web/order/unusual_trade.aspx?";
            ...
            object dt = new DB.BLL.MB_Bll(DBEnum.Slave).GetByPageUnusualTradeList(byTimeStart,byTimeEnd,comfirmStatus,byPayID,searchName, (pageNow - 1) * pageSize, pageSize,out moneyAmount);           
