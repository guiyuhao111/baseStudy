<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="DSMTMALL.BACKMAG.web.order.order_list" %>
...
<body class="sticky-header">
    <section>
                        ...
                        <asp:Repeater ID="repeaterOrderList" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td name="tName" class="width_min_150" title="<%# Eval("UserName") %>"><a tabindex="0" role="button" data-toggle="popover" data-container="body" data-trigger="focus" title="所属公司名：<%# Eval("CpyName")%>" data-content="消费总额：<%# Eval("CreditLine")%>"><%# Eval("NickName") %>-<%# Eval("UserName") %></a></td>
                                    ...
                                    <td name="tCreateTime"><a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-content="订单日志：<%# Eval("LogInfo")%>"><%# Eval("AddTime") %></a></td>
                                    <td name="tOperation" mydata="<%# Eval("OrderID") %>">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#reBackModal" onclick="ShowRebackInfo(this)"><span class="fa fa-reply-all"></span></button>
                                        </div>
                                    </td>
        ...
        <div id="divHelper">
            ...
            <%--============退货登记======--%>
            <div class="modal fade" id="reBackModal" tabindex="-1" role="dialog" aria-labelledby="reBackModal" aria-hidden="true">
                <div class="modal-dialog" style="min-width: 100px">
                    <div class="modal-content">
                        <form onsubmit="return false;">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h4 class="modal-title">退货登记</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-12">
                                        <div class="thumbnail">
                                            <div class="caption">
                                                <ul class="list-group order_back_css" id="orderProductList_back">
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="telPhone_back">联系方式：</label>
                                            <input type="tel" class="form-control" id="telPhone_back" placeholder="请输入联系方式..." required="required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="type_back">退款类型：</label>
                                            <select id="type_back" class="form-control input-sm" required="required">
                                                <option value="10">我要退货</option>
                                                <option value="20">我要换货</option>
                                                <option value="30">我要退款</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="remark_back">退货原因</label>
                                            <textarea id="remark_back" rows="3" class="form-control" required="required"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
